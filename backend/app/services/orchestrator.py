...
async def run_deployment(deployment_id: str, project: Project, env: Environment, server: Server, build_strategy: str) -> None:
    ...
    work_dir = tempfile.mkdtemp(prefix="qualify_")
